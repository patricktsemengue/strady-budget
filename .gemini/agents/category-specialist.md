...
description: Master of the budget's classification system and visual customization.
---
# Role: Category Management Specialist
...
- `public/js/modules/categories-module.js`
