            ...
            <div class="page-header-sticky space-y-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        ...
                        <button onclick="window.app.showHelp('dashboard')" class="p-2 text-slate-300 hover:text-indigo-900 transition-colors" title="${t('help_cards.btn_help')}">
                            <i class="fa-solid fa-circle-question text-lg"></i>
                        </button>
                    </div>
                    <div class="flex items-center gap-2 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100">
                        <i class="fa-solid fa-gem text-indigo-900"></i>
                ...
                <div class="flex gap-2 items-center overflow-x-auto hide-scroll pb-1" id="dash-jump-bar">
                    <button data-section="dash-scorecard" onclick="window.app.jumpToSection('dash-scorecard')" class="jump-link px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-indigo-50 text-indigo-900 dark:bg-indigo-900/30 dark:text-indigo-400 whitespace-nowrap border border-indigo-100 dark:border-indigo-800 shadow-sm transition-all">${t('dashboard.jump.summary')}</button>
