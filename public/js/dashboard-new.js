        ...
        <div class="space-y-8">
            ...
            <div id="dash-kpis" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between relative overflow-hidden">
                    <!-- Inline Multiplier Selector Overlay -->
                    <div id="runway-config-overlay" class="absolute inset-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm z-20 flex flex-col items-center justify-center p-6 opacity-0 pointer-events-none transition-all duration-300">
                        <p class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4">Objectif de Sécurité</p>
                        <div class="flex items-center gap-2 bg-slate-50 dark:bg-slate-800 p-1 rounded-2xl border border-slate-100 dark:border-slate-800 w-full">
                            <button onclick="window.app.updateEFMultiplier(3)" class="flex-1 py-2.5 rounded-xl text-xs font-bold transition-all ${runwayGoal === 3 ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'}">3m</button>
                            <button onclick="window.app.updateEFMultiplier(6)" class="flex-1 py-2.5 rounded-xl text-xs font-bold transition-all ${runwayGoal === 6 ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'}">6m</button>
                            <button onclick="window.app.updateEFMultiplier(12)" class="flex-1 py-2.5 rounded-xl text-xs font-bold transition-all ${runwayGoal === 12 ? 'bg-indigo-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'}">12m</button>
                        </div>
                        <button onclick="document.getElementById('runway-config-overlay').classList.add('opacity-0', 'pointer-events-none')" class="mt-4 text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest hover:underline">Fermer</button>
                    </div>
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex gap-1">
                            <button onclick="document.getElementById('runway-config-overlay').classList.remove('opacity-0', 'pointer-events-none')" class="p-2 text-slate-300 hover:text-indigo-600 transition-colors">
